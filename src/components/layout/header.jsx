          ...
          <nav className="navbar navbar-expand-lg navbar-light p-0">
            ...
            >
              <ul className="navbar-nav">
                ...
                <li className="nav-item">
                  <Link className="nav-link p-0" to="/about-us">
                    About Eduroam
                  </Link>
                </li>
                <li className="nav-item">
                  <Link className="nav-link p-0" to="/institutions">
                    Indian Presence
                  </Link>
                </li>
                <li className="nav-item">
            ...
            <Link className="navbar-brand p-0" to="/domain">
              <figure className="mb-0">
                <img
                  src="/images/Government_of_India_logo.webp"
                  alt="header-logo"
                  loading="lazy"
                />
              </figure>
